...
function SaveSettingWarn({ isShow, setShow, id, user, logoRef }: DataTypes) {
      ...
      >
        ...
        <div className="px-8 pt-10 pb-8 text-center">
          ...
          <p className="mt-6 text-[15px] leading-6 text-slate-500">
            By saving your changes, all existing information associated with
            your account will be updated to reflect the new details you’ve
            entered. Additionally, a new VCF (Virtual Contact File) will be
            generated to ensure your contact information, including social
            links, profile image, and other relevant details, is up to date and
            ready for sharing.
          </p>
...
export default SaveSettingWarn;
