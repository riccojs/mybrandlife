...
const LogoutModal = ({ onLogout, onCancel, isLoading }: DataType) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-120 bg-white dark:bg-slate-900 shadow-2xl rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 zoom-animation">
        <div className="py-10 bg-[#DBEDFB] bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="px-8 pt-8 pb-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row-reverse gap-3">
            <button
              onClick={onLogout}
              className="flex-1 min-w-35 cursor-pointer items-center justify-center rounded-lg h-12 bg-primary hover:bg-primary/90 text-black font-medium transition-all bg-[#FFAA00] shadow-md shadow-primary/20"
            >
              {isLoading ? (
            ...
            <button
              onClick={onCancel}
              className="flex-1 min-w-35 cursor-pointer items-center justify-center rounded-lg h-12 bg-[#EEF3F8] dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-slate-100 font-medium transition-all"
            >
