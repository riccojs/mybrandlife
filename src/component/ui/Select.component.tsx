  ...
  return (
    <div className="relative w-full" ref={downRef}>
      <div
        ...
        className="border border-gray-300 cursor-pointer text-sm focus-within:border-[#96c94b] focus-within:border py-3 flex gap-2 items-center justify-between px-3 w-full text-center rounded-xl text-normal"
      >
      ...
      >
        <li
          ...
          className={`text-normal text-sm px-3 py-2 cursor-pointer hover:bg-[#F3F3F3] rounded-xl ${
            value === "" ? "bg-[#F3F3F3]" : ""
          }`}
        >
          {label}
